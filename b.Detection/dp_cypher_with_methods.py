...
RETURN DISTINCT
	...
	factoryMethod.signature as factoryMethod
"""
...
RETURN DISTINCT
	...
	ConcreteBuilder.qualifiedName as ConcreteBuilder,
	Product.qualifiedName as Product,
	construct.signature as construct,
	buildPart.signature as buildPart,
	getResult.signature as getResult
UNION MATCH
...
RETURN DISTINCT
	...
	clone.signature as clone,
    prototype.name as prototype
UNION MATCH
...
RETURN DISTINCT
    ...
    notify.signature as notify,
    update.signature as update,
    observers.name as observers
UNION MATCH
